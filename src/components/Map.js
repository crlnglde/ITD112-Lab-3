...
const mapContainerStyle = {
  width: '100%',
  height: '500px',  // Adjust the height of the map as needed
  marginTop: '20px'
};
...
const DengueMap = ({ dengueDb = [] }) => {
  ...
  const findMatchingRegion = (regionName) => {
    ...
    return dengueDb.find(data => normalizeString(data.region).includes(normalizeString(regionName)));
  };
